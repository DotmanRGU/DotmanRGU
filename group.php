...
<div class="row">
            ...
            <form class="form-horizontal" method="post" action="groupexe.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <select class='col-md-12 form-control' name='grpzzz'>
                        ...
                        $grp1 = mysqli_query($serverconnect, $grp);
    ...
    <tr>
        <th scope="row">' . $ct . '</th>
        <td><a href="">';
                echo "<a href='grouping.php?=" . $row2['userid'] . "' class='list-group-item'style=\"text-align: center\">" . $row2['group_name'] . "</a>";
                echo "<td><a href='deletecrs.php?=" . $row2['userid'] . "' class='list-group-item'style=\"text-align: center\">Delete</a>";
                echo "</a></td>
            </tr>";
